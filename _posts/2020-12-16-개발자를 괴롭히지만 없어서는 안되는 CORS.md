...
![](cors.assets/Credentialed_1.JPG)
...
![](cors.assets/Credentialed_2.JPG)

블로그를 호스팅하고 있는 Github 서버는 이번에도 동일한 응답을 보내주었지만, 브라우저의 반응은 다르죠.

![](cors.assets/Credentialed_3.JPG)
